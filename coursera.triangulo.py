class Poligono:
    ...
    def le_lados(self):
        self.lados = [float(input('Informe o tamanho do lado ' + str(i+1) + ": ")) for i in range(self.n)]
...
class Triangulo(Poligono):
    ...
    def area(self):
        ...
        print('A área do triângulo é {area:0.2f}')
...
class Retangulo(Poligono):
    ...
    def le_lados(self):
        lado1 = float(input('Digite tamanho do lado1: '))
